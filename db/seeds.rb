...
create_account = User.create([email: 'liumiao2023@gmail.com', password: '123456', password_confirmation: '123456', is_admin: 'true',balance:0])
puts "Admin account created."
...
=======
create_question = Question.create([title:'请问如何申请斯坦福大学呢？',description:'明年9月份想去斯坦福，不知道有没有大神可以给些意见？',user_id:1,downpayment:200,is_hidden:false,status:'open'])
create_question = Question.create([title:'想了解一下日本的留学政策？',description:'近年来，又迎来了一股赴日留学的新潮流，留学日本提前了解留学新政策是必须的，这样可以帮助留学生更好的准备留学规划，做好留学准备。',user_id:1,downpayment:200,is_hidden:false,status:'open'])
create_question = Question.create([title:'如何申请日本研究生？',description:'很多同学想要赴日本留学读研，但是日本语中国的研究生是不一样的，日本的研究生分为修士研究生和博士研究生两种。',user_id:1,downpayment:200,is_hidden:false,status:'open'])

create_question = Question.create([title:'谁呢那个给讲讲美国大学的排名？',description:'作为权威性相当高的美国学校排名，2016年USNEWS全美综合大学排名正式也有很多的改变。综合大学前100中有81所学校出现了排名变化，可谓是最近几年最大变动。',user_id:2,downpayment:200,is_hidden:false,status:'open'])
create_question = Question.create([title:'香港留学计算机专业，谁能讲讲？',description:'目前去香港读计算机专业的学生逐年递增，以前因为香港是有名的金融商业中心，给绝大多数的学生留下的印象都是香港的商科很强，计算机和信息技术等理工科专业与商科相差甚远。',user_id:2,downpayment:200,is_hidden:false,status:'open'])
...
>>>>>>> 08e191dbd44e2a1dddc2a2fd7ff47dd6a4e9e61d
